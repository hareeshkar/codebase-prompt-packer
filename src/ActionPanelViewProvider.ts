...
export class ActionPanelViewProvider implements vscode.WebviewViewProvider {
    ...
    public resolveWebviewView(
        ...
        webviewView.webview.onDidReceiveMessage(data => {
            switch (data.type) {
                case 'copyPrompt':
                    vscode.commands.executeCommand('codebasePromptPacker.copyPackedPrompt');
                    break;
                case 'previewPrompt':
                    vscode.commands.executeCommand('codebasePromptPacker.previewPackedPrompt');
                    break;
                case 'copyTreeOnly':
                    vscode.commands.executeCommand('codebasePromptPacker.copyTreeOnly');
                    break;
                case 'toggleFullTree':
                    vscode.commands.executeCommand('codebasePromptPacker.toggleFullStructure');
                    break;
                case 'selectAll':
